...
namespace api {
	...
	v8::Handle<v8::ObjectTemplate> Navigator::generate() {
		...
		tpl->Set(v8::String::New("platform"), v8::String::New("Android 4.1 (API Level 14)"));
#else
		tpl->Set(v8::String::New("userAgent"), v8::String::New("V8GL/2.0 (GL; Linux i686) lycheeJS-ADK"));
		tpl->Set(v8::String::New("appVersion"), v8::String::New("2.0 (GL; Linux i686) lycheeJS-ADK"));
		tpl->Set(v8::String::New("platform"), v8::String::New("Linux i686"));
#endif
